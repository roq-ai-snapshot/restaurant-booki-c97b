  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine - Your digital partner in managing table reservations and menus, ensuring a seamless dining experience for your customers."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine - Your digital partner in managing table reservations and menus, ensuring a seamless dining experience for your customers.`}
            </Text>
            <Box
